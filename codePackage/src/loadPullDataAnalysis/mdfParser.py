...
def parseMdf(fileLoc: str) -> pd.DataFrame:
    ...
    :param fileLoc: The file location of the MDF file, if the file is in the same directory,
...
def calculateMetrics(df: pd.DataFrame) -> pd.DataFrame:
    ...
    :param df: The pandas data frame generated by the parseMdf function.
...
def unitConversions(df: pd.DataFrame) -> pd.DataFrame:
    ...
    :param df: The pandas data frame generated by the calculatedMetrics function.
    :type df: pandas.DataFrame
...
def exportFiles(df: pd.DataFrame, filepath: str) -> None:
    ...
    :param df: The pandas data frame generated by the calculatedMetrics or unitConversions function.
    :type df: pandas.DataFrame
    :param filepath: The name of the file to be saved + the location. path/filename, if the file is to be
